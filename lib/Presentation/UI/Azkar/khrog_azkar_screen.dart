...
import 'package:azkar_application_/Data/Datasource/local.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class KhrogAzkarPage extends StatefulWidget {
  KhrogAzkarPage({Key? key, required this.categoryName, required this.id})
      : super(key: key);
...
class _KhrogAzkarPageState extends State<KhrogAzkarPage> {
  ...
  Future<void> initializePreferences() async {
    ...
    setState(() {
      ...
      _timeOfDay2 =
          getTimeFromPreferences() ?? const TimeOfDay(hour: 7, minute: 00);
  ...
  Future<void> scheduleNotification() async {
    ...
    var selectedTime = DateTime(
        now.year, now.month, now.day, _timeOfDay2.hour, _timeOfDay2.minute);
